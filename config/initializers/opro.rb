Opro.setup do |config|
  ...
  config.login_method             { |controller, current_user| controller.current_user = current_user }
  config.logout_method            { |controller, current_user| controller.current_user = nil }
  config.authenticate_user_method { |controller| controller.authorize }
